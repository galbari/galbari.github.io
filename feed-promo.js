function transitionBanner() {
    ...
    function getStyle() {
        ...
        styleDiv.innerHTML = '<style>' +
            ...
            '.tbl-cards-slider .clickAction { width: 145px; position: absolute; top: 0px; left: 0px; font-weight: bold; font-size: 16px; color: #000000; padding: 25px; visibility: hidden; opacity: 0;}' +
